...
<head>
	...
	<title>Block Palettes - Farmland</title>
...
<div class="container">
	...
	<div class="row" style="padding: 30px 0px 0px 0px;">
		...
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-md-4">
	            	<img src="../img/blocks/hay-bale.jpg" width="100%;">
	            </div>
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Hay Bale</h5>
	            	<p class="font-faded">ID : 170<br>(minecraft:hay_block)</p>
	            </div>
        	</div>	
		</div>
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-md-4">
	            	<img src="../img/blocks/red-concrete-powder.jpg" width="100%">
	            </div>
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Red Concrete Powder</h5>
	            	<p class="font-faded">ID : 252:14<br>(minecraft:concrete_powder)</p>
	            </div>
        	</div>	
		</div>
	</div>
