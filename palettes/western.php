...
<head>
	...
	<title>Block Palettes - Western Palette</title>
...
<div class="container">
		...
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-md-4">
	            	<img src="../img/blocks/brown_mushroom_block.png" width="100%;" class="pixelFix">
	            </div>
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Brown Mushroom Block</h5>
	            	<p class="font-faded">ID : 99<br>(minecraft:brown_mushroom_block)</p>
	            </div>
        	</div>
		</div>
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-md-4">
	            	<img src="../img/blocks/brown-terracotta.jpg" width="100%;">
	            </div>
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Brown Hardened Clay</h5>
	            	<p class="font-faded">ID : 159:12<br>(minecraft:stained_hardened_clay)</p>
	            </div>
        	</div>	
		</div>
		<div class="col-md-4">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-sm-4">
	            	<img src="../img/blocks/terracotta.jpg" width="100%">
	            </div>
	            <div class="col-8 col-sm-8" style="padding-top: 10px">
	            	<h5 class="nospace">Hardened Clay</h5>
	            	<p class="font-faded">ID : 172<br>(minecraft:hardened_clay)</p>
	            </div>
        	</div>
		</div>
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            ...
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Orange Hardened Clay</h5>
		...
		<div class="col-md-4">
			<div class="row" style="padding-top: 10px">
	            <div class="col-4 col-md-4">
	            	<img src="../img/blocks/barrel_side.png" width="100%;" class="pixelFix">
	            </div>
	            <div class="col-8 col-md-8" style="padding-top: 10px">
	            	<h5 class="nospace">Barrel</h5>
	            	<p class="font-faded">ID : 457<br>(minecraft:barrel)</p>
	            </div>
        	</div>	
		</div>
	</div>
